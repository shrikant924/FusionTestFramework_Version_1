...
deviceDetails = read_Json_file('\\Com.visionProject.Android\\Com.visionProject.Android\\VisionProject.Config.Files'
                               '\\deviceDetails.json')
testData = read_Json_file('\\Com.visionProject.Android\\Com.visionProject.Android\\VisionProject.Config.Files\\testData'
                          '.json')
